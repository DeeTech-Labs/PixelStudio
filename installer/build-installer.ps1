...
function Get-InstallerRuntimeFiles {
    return @(
        ...
        'PixelStudio/src/qml/dialogs/qmldir'
        'PixelStudio/src/qml/dialogs/AboutBrandMark.qml'
        'PixelStudio/src/qml/dialogs/AboutDialog.qml'
        'PixelStudio/src/qml/settings/SyntaxColorsEditor.qml'
        ...
        'PixelStudio/src/qml/features/export/ExportHub.qml'
        'PixelStudio/src/qml/panels/InspectorPageImage.qml'
        'PixelStudio/src/qml/shell/qmldir'
        'PixelStudio/src/qml/shell/MainMenuBar.qml'
        'PixelStudio/src/qml/shell/MainDialogs.qml'
        'PixelStudio/src/qml/settings/SettingsPage.qml'
        'PixelStudio/src/qml/settings/SettingsNavButton.qml'
        'PixelStudio/src/qml/shell/studio/qmldir'
        'PixelStudio/src/qml/shell/studio/StudioDialog.qml'
        'PixelStudio/src/qml/shell/studio/StudioShell.qml'
        'PixelStudio/src/qml/shell/studio/StudioStatusBar.qml'
        'PixelStudio/src/qml/shell/studio/StudioTabBar.qml'
        'PixelStudio/src/qml/shell/studio/StudioTabChip.qml'
        'PixelStudio/src/qml/shell/studio/StudioToast.qml'
        'PixelStudio/src/qml/shell/studio/StudioToolbar.qml'
        'PixelStudio/src/qml/studio/qmldir'
        'PixelStudio/src/qml/studio/PixelDottedRule.qml'
        'PixelStudio/src/qml/studio/PixelFrame.qml'
        'PixelStudio/src/qml/studio/PixelPanel.qml'
        'PixelStudio/src/qml/studio/PixelTab.qml'
        'PixelStudio/src/qml/studio/StudioBackdrop.qml'
        ...
        'PixelStudio/src/qml/welcome/WelcomeBrandMark.qml'
        'PixelStudio/src/qml/welcome/WelcomeFooterNav.qml'
        'PixelStudio/src/qml/welcome/WelcomeRecentCard.qml'
        'PixelStudio/src/qml/welcome/WelcomeScreen.qml'
        'PixelStudio/src/qml/welcome/WelcomeSparkle.qml'
        'PixelStudio/src/qml/workspace/qmldir'
        'PixelStudio/src/qml/workspace/CodePanel.qml'
        'PixelStudio/src/qml/workspace/CodeSyntaxView.qml'
        'PixelStudio/src/qml/workspace/StudioDropCanvas.qml'
        'PixelStudio/src/qml/workspace/StudioLayout.qml'
        'PixelStudio/src/qml/workspace/dock/qmldir'
        'PixelStudio/src/qml/workspace/dock/LeftAssetDock.qml'
        'PixelStudio/src/qml/workspace/dock/PalettePanel.qml'
        'PixelStudio/src/qml/workspace/dock/ProjectPanel.qml'
